...
public class LowGoalCommand extends SequentialCommandGroup {
    ...
    public LowGoalCommand(PivotSubsystem pivot, WristSubsystem wrist, TelescopeSubsystem telescope) {
        addCommands(
            new ParallelCommandGroup(
                new PivotPositionCommand(pivot, Rotation2d.fromRadians(PivotPositionConstants.kLowScorePos)),
                new WristPositionCommand(wrist, Rotation2d.fromRadians(WristPositionConstants.kLowScorePos)),
