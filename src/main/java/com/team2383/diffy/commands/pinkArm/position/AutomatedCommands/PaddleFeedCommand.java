...
public class PaddleFeedCommand extends SequentialCommandGroup {

    public PaddleFeedCommand(PivotSubsystem pivot, WristSubsystem wrist, TelescopeSubsystem telescope) {
        addCommands(
            new ParallelCommandGroup(
                new PivotPositionCommand(pivot, Rotation2d.fromRadians(PivotPositionConstants.kFeedPaddlePos)),
                new WristPositionCommand(wrist, Rotation2d.fromRadians(WristPositionConstants.kFeedPaddlePos)),
