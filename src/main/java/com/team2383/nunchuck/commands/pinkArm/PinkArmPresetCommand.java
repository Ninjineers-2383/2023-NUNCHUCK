package com.team2383.nunchuck.commands.pinkArm;

import java.util.function.BooleanSupplier;

import com.team2383.nunchuck.commands.pinkArm.position.PivotPositionCommand;
import com.team2383.nunchuck.commands.pinkArm.position.TelescopePositionCommand;
import com.team2383.nunchuck.commands.pinkArm.position.WristPositionCommand;
...
public class PinkArmPresetCommand extends SequentialCommandGroup {
    ...
    public PinkArmPresetCommand(PivotSubsystem pivot, TelescopeSubsystem telescope, WristSubsystem wrist,
        ...
        BooleanSupplier m_needToReset = () -> (((Math.signum(m_pivot.getAngle().getDegrees()) != Math
                ...
                && (m_pivot.getAngle().getDegrees() < -60 || m_pivot.getAngle().getDegrees() > 17));
        addCommands(
